...
class FlashPhotoApp : public mingfx::GraphicsApp {
 public:
  ...
  /** @brief Called when the mouse moves but no
  ...
  /** @brief Called when the user moves the mouse with the left button 
   * depressed. */
  ...
  /**  @briefCall this from the controller to apply the threshold filter to the current
